 ...
 * b) Make TeslaModelS implements the ElectricVehicle interface.
 * c) Uncomment the code below and try to understand the different statements
 */
public class Exercise1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(teslaModelS.speed()); //Compilation Error
