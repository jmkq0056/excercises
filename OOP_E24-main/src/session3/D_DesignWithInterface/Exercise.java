 ...
 *   - Uncomment the code in the ChessDemo class, understand why you get the compilation errors and fix it.
...
public class Exercise {
    ...
    public static void main(String[] args) {
        ...
        feedback.Feedback.submit("session3_D_Bishop", I_did_finish, I_did_understand, comment);
    */
    }
}
